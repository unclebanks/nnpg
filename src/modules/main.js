...
import { getPokemonDataByName, getRouteIndexByName, mergeArray, randomArrayElement } from './utilities';
...
export const BALLRNG = {
    pokeball: 1,
    greatball: 1.5,
    ultraball: 2,
    masterball: 100
};
export const makeEnemy = (starter) => {
    let active = starter;
    ...
    const trainerPoke = (pokemonList) => {
        ...
        const poke = getPokemonDataByName(pokemonList[selected][0]);
    ...
    const generateNew = (regionId, routeId) => {
        ...
        const routeData = regionData[getRouteIndexByName(regionId,routeId)];
        let pokemonList = [];
        ...
        const poke = getPokemonDataByName(randomArrayElement(pokemonList));
...
export let lastSave = Date.now();
export let player = new Player();
export let enemy = makeEnemy();
export const town = new Town();
export const dom = new Display();
export const combatLoop = new Combat();
export const userInteractions = new UserActions();
// load old save data
